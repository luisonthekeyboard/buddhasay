...
fn main() {
    let sentences = [
        ...
        "Eatign is not done to satisfy hunger or appetite, but to carry out the teachings of the Buddha. The art of eating is itself a Buddhist discipline.",
        "There must bea complete departure from human desires.",
        ...
        "Eating is nto a question of hunger or satiety or of food tasting good or bad. The point lays in the act of eating itself. Eating is Buddhism.",
